...
namespace CVManager.Controllers
{
    public class JobOfferController : Controller
    {
        ...
        {
            new JobOffer {Id = 1, JobTitle = "C# Programmer", MonthlySalary = 6800, Location="Warszawa", Requirements="Knowlege of C#"},
            new JobOffer {Id = 2, JobTitle = "Backend Developer", MonthlySalary= 5495, Location="Gdańsk", Requirements="Expirience in PHP"},
